                   ...
                   <form method="POST" action="/Assignment_Sof3011_war_exploded/LoginServlet/login">
                       ...
                       <div class="input-group mb-3 pe-5">
                           <input type="text" class="form-control"
                                  placeholder="ex: 0582434619/phamlequyenanh1308@gmail.com"
                                  aria-label="Username" name="email">

                       </div>
                       <div class="input-group mb-3 pe-5">
                           <input type="password" class="form-control" placeholder="Vui lòng nhập mật khẩu"
                                  aria-label="Password" name="matKhau"
                           >
                       </div>
                       <br>
                       <button class=" btn btn-success  w-75 h-30 mt-3 fs-4"
                       >Đăng nhập
                       </button>
                       <br>
                       ...
                       <a class="btn text-white  " href="#" role="button" style="background-color: #3B5998;">
                           Facebook
                       </a>
                       <a class="btn text-white " href="#" role="button" style="background-color: #EA4335;">
                           Google
                       </a>
                       <br>
                       <span>
            <p> * Có thể đăng nhập nhanh hoặc đăng ký thành viên mới bằng tài khoản mạng xã hội.</p>
            <p> * Thành viên Innisfree chưa liên kết với tài khoản mạng xã hội có thể đăng nhập và thiết lập liên kết
              một cách nhanh chóng</p>
                ...
                <div class=" col-5 text-center ps-5 mt-5 ">
                    ...
                    <br>
                    <span class="ms-3">Đăng ký ngay để mua sắm dễ dàng hơn và tận hưởng thêm nhiều ưu đãi độc quyền cho thành viên
            innisfree.</span>
                    <br>
